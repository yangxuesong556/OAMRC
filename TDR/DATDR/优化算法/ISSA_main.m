...
clear;
tic
popmin=[0.01,0.01,0.01,1,1,2];%h,gamma,alpha,p,Delay,layer
popmax=[3,3,3,10,10,10];  %初始范围    
maxgen=200; %迭代次数，最大迭代次数
sizepop = 20;  %种群规模100
Vmax = [0.075,0.15,0.15,1.5,1.5,1.5];       %粒子移动最大速度5，变化趋势
...
lb=popmin;%下界
ub=popmax;%上界
%Convergence_curve = zeros(Max_iter,1);%记录最优适应度值曲线
N0=sizepop;%种群数量
